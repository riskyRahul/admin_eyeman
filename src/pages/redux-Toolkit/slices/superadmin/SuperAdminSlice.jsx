...
const SuperAdminSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(
      reqtoSuperAdminCountriesWiseCountry.fulfilled,
      (state, action) => {
    ...
    builder.addCase(
      reqtoSuperAdminDeleteLocation.fulfilled,
      (state, action) => {
        state.deleteLoader = false;
    ...
    builder.addCase(
      reqtoSuperAdminGeteventCategory.fulfilled,
      (state, action) => {
        state.loader = false;
    ...
    builder.addCase(
      reqtoSuperAdminDeleteEventCategory.fulfilled,
      (state, action) => {
        state.deleteLoader = false;
    ...
    builder.addCase(
      reqtoSuperAdminGetCategoryRequest.fulfilled,
      (state, action) => {
        state.loader = false;
    ...
    builder.addCase(
      reqtoSuperAdminStatusLocations.fulfilled,
      (state, action) => {
    ...
    // reqtoSuperAdminGetSettings
    builder.addCase(reqtoSuperAdminGetSettings.pending, (state) => {
      state.settingsLoader = true;
      state.error = null;
    });
    builder.addCase(reqtoSuperAdminGetSettings.fulfilled, (state, action) => {
      state.settingsLoader = false;
      state.settingsList = action.payload?.data || [];
    });
    builder.addCase(reqtoSuperAdminGetSettings.rejected, (state, action) => {
      state.settingsLoader = false;
      state.error = action.payload;
    });

    // reqtoSuperAdminAddSettings
    builder.addCase(reqtoSuperAdminAddSettings.pending, (state) => {
      state.addSettingsLoader = true;
    });
    builder.addCase(reqtoSuperAdminAddSettings.fulfilled, (state, action) => {
      state.addSettingsLoader = false;
    });
    builder.addCase(reqtoSuperAdminAddSettings.rejected, (state, action) => {
      state.addSettingsLoader = false;
    });

    // reqtoSuperAdminEditSettings
    builder.addCase(reqtoSuperAdminEditSettings.pending, (state, action) => {
      state.editSettingsLoader = true;
    });
    builder.addCase(reqtoSuperAdminEditSettings.fulfilled, (state, action) => {
